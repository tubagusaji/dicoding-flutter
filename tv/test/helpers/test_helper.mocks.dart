...
import 'package:tv/data/datasources/db/database_helper.dart' as _i14;
...
class MockTvRepository extends _i1.Mock implements _i5.TvRepository {
  ...
  @override
  _i6.Future<bool> isInWatchList(int? id) => (super.noSuchMethod(
        Invocation.method(
          #isInWatchList,
          [id],
        ),
...
class MockTvLocalDataSource extends _i1.Mock implements _i12.TvLocalDataSource {
  ...
  @override
  _i6.Future<void> cacheNowPlayingTv(List<_i13.TvTable>? tvList) =>
      (super.noSuchMethod(
        Invocation.method(
          #cacheNowPlayingTv,
          [tvList],
  ...
  @override
  _i6.Future<List<_i13.TvTable>> getCacheNowPlayingTv() => (super.noSuchMethod(
        Invocation.method(
          #getCacheNowPlayingTv,
          [],
        ),
        returnValue: _i6.Future<List<_i13.TvTable>>.value(<_i13.TvTable>[]),
      ) as _i6.Future<List<_i13.TvTable>>);
  @override
  _i6.Future<void> cachePopularTv(List<_i13.TvTable>? tvList) =>
      (super.noSuchMethod(
        Invocation.method(
          #cachePopularTv,
          [tvList],
  ...
  @override
  _i6.Future<List<_i13.TvTable>> getCachePopularTv() => (super.noSuchMethod(
        Invocation.method(
          #getCachePopularTv,
          [],
        ),
  ...
  @override
  _i6.Future<String> insertTvWatchList(_i13.TvTable? tvTable) =>
      (super.noSuchMethod(
        Invocation.method(
          #insertTvWatchList,
          [tvTable],
  ...
  @override
  _i6.Future<String> removeTvWatchList(_i13.TvTable? tvTable) =>
      (super.noSuchMethod(
        Invocation.method(
          #removeTvWatchList,
          [tvTable],
  ...
  @override
  _i6.Future<void> cacheTopRatedTv(List<_i13.TvTable>? tvList) =>
      (super.noSuchMethod(
        Invocation.method(
          #cacheTopRatedTv,
          [tvList],
  ...
  @override
  _i6.Future<List<_i13.TvTable>> getCacheTopRatedTv() => (super.noSuchMethod(
        Invocation.method(
          #getCacheTopRatedTv,
          [],
        ),
...
class MockTvDatabaseHelper extends _i1.Mock implements _i14.TvDatabaseHelper {
  ...
  @override
  _i6.Future<List<Map<String, dynamic>>> getCacheTvList(String? category) =>
      (super.noSuchMethod(
        Invocation.method(
          #getCacheTvList,
          [category],
