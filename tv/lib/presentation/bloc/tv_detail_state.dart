...
class TvDetailState extends Equatable {
  static const addTvSuccesMsg = 'Added Tv to Watchlist';
  static const removeTvSuccessMsg = 'Removed Tv from Watchlist';

  final TvDetail tvDetail;
  final RequestState tvDetailState;
  final List<Tv> tvRecommendations;
  final RequestState tvRecommendationsState;
  final bool isInTvWatchList;
  final String msg;
  final String tvWatchlistMessage;
  ...
  required this.isInTvWatchList,
  required this.msg,
  required this.tvWatchlistMessage});
  TvDetailState copyWith({
    TvDetail? tvDetail,
    RequestState? tvDetailState,
    List<Tv>? tvRecommendations,
    RequestState? tvRecommendationsState,
    bool? isInTvWatchList,
    String? msg,
    String? tvWatchlistMessage,
  }){
    return TvDetailState(
      ...
      isInTvWatchList: isInTvWatchList ?? this.isInTvWatchList,
      msg: msg ?? this.msg,
      tvWatchlistMessage: tvWatchlistMessage ?? this.tvWatchlistMessage,
    );
  }

  factory TvDetailState.initial() => TvDetailState(tvDetail: tvDetailInitial,
...
TvDetail tvDetailInitial = TvDetail(
